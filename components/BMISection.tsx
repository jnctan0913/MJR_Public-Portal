                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 min-w-0 p-2.5 rounded-lg border border-gray-200 text-dksh-black text-base font-poppins focus:border-dksh-red focus:ring-2 focus:ring-dksh-red/20 focus:outline-none transition-all shadow-sm"
                      ...
                      <select
                        ...
                        className="w-16 px-2 py-2 rounded-lg border border-gray-200 text-dksh-black text-base font-poppins focus:border-dksh-red focus:ring-2 focus:ring-dksh-red/20 focus:outline-none bg-white transition-all cursor-pointer shadow-sm"
                      >
